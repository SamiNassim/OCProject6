...
export function About() {
    ...
    return (
        <><Banner bgimg="banner__div__about" bgtext={{ display: "none" }} /><div className="about__div">
            <Collapse title="Fiabilité" text={fiab} id="fiab" />
            <Collapse title="Respect" text={respect} id="respect" />
            <Collapse title="Service" text={service} id="service" />
            <Collapse title="Sécurité" text={securite} id="securite" />
        </div></>
    )
}